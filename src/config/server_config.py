...
AdminConfigVar_1=AdminTask.createDatasource(AdminConfigVar_0, ["-name", "Default Datasource", "-jndiName", "DefaultDatasource", "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DerbyDataStoreHelper", "-configureResourceProperties", "[[databaseName java.lang.String ${APP_INSTALL_ROOT}/${CELL}/pbw-ear.ear/DefaultDB] ]"])
